...
export const DailyDuaCard = () => {
  return (
    <Card className="relative overflow-hidden glass-dark px-5 py-5 shine-effect">
      {/* Decorative elements */}
      <div className="absolute top-0 left-0 w-24 h-24 bg-[radial-gradient(circle_at_top_left,hsl(145_70%_45%/0.08),transparent_60%)] pointer-events-none" />
      
      <div className="relative z-10">
        <div className="flex items-center gap-2 mb-3">
          <h2 className="text-sm font-bold text-emerald-gradient">Daily Dua</h2>
        ...
        <div className="mt-4 flex gap-2">
          <span className="rounded-xl bg-gradient-to-r from-primary/20 to-primary/10 border border-primary/25 px-4 py-1.5 text-xs font-bold text-primary shadow-[0_0_10px_-3px_hsl(145_70%_45%/0.2)]">
            Arabic
          </span>
