          ...
          <motion.div className="space-y-8">
            ...
            >
              <input
                ...
                required
                className="flex-1 px-4 py-3 sm:py-4 text-base rounded-lg bg-white border-2 border-slate-200 focus:border-teal-500 focus:outline-none transition placeholder:text-slate-400"
              />
              <motion.button
                type="submit"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="px-6 sm:px-8 py-3 sm:py-4 bg-teal-600 hover:bg-teal-700 text-white font-semibold rounded-lg transition flex items-center justify-center gap-2"
              >
                Join
                <span>→</span>
              </motion.button>
            ...
            >
              ...
              <span className="font-medium">Thanks for joining our waitlist!</span>
            </motion.div>
